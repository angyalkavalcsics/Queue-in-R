...
We can use the function solverouting() to accomplish this. The only input necessary is the routing matrix and the function returns and error if R is not a square matrix with nonnegative entries so that every row adds up to at most 1. As with open Jackson networks, the routing matrix is assumed to be irreducible and non-absorbing.
